        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <a href="user.php"><li class="list-group-item active">Profile Information</li></a>
                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" value="<?php echo htmlspecialchars($user['firstname'].$user['lastname']); ?>" <?php echo $edit;?>>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" value="<?php echo htmlspecialchars($user['firstname'].$user['lastname']); ?>" <?php echo $edit;?>>
                        </div>
                        <div class="mb-3">
                            <label for="address" class="form-label">Address</label>
                            <textarea class="form-control" id="address" rows="3" <?php echo $edit;?>><?php echo htmlspecialchars($user['email']); ?></textarea>
                        </div>
